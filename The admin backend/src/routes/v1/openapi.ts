export const openApiDocument = {
  ...
  paths: {
    ...
    "/client/kyc/requirements": { get: { tags: ["Client"], summary: "Read active KYC requirements and upload progress", security: [{ cookieSession: [] }] } },
    "/client/kyc/start": { post: { tags: ["Client"], summary: "Start a KYC case", security: [{ cookieSession: [], csrf: [] }] } },
    "/client/kyc/documents": { post: { tags: ["Client"], summary: "Upload a document into a configured KYC slot", security: [{ cookieSession: [], csrf: [] }] } },
    "/client/kyc/submit": { post: { tags: ["Client"], summary: "Submit a complete KYC case for review", security: [{ cookieSession: [], csrf: [] }] } },
    ...
    "/client/notifications": { get: { tags: ["Client"], summary: "List client notifications", security: [{ cookieSession: [] }] } },
    "/client/notifications/inbox": { get: { tags: ["Client"], summary: "Poll client notification inbox", security: [{ cookieSession: [] }] } },
    "/client/notifications/{id}/read": { post: { tags: ["Client"], summary: "Mark a client notification as read", security: [{ cookieSession: [], csrf: [] }] } },
    "/client/notifications/read-all": { post: { tags: ["Client"], summary: "Mark all client notifications as read", security: [{ cookieSession: [], csrf: [] }] } },
    ...
    "/admin/kyc/requirements": { get: { tags: ["Admin"], summary: "List KYC document requirements", security: [{ cookieSession: [] }] }, post: { tags: ["Admin"], summary: "Create a KYC document requirement", security: [{ cookieSession: [], csrf: [] }] } },
    "/admin/kyc/requirements/{id}": { patch: { tags: ["Admin"], summary: "Update or deactivate a KYC document requirement", security: [{ cookieSession: [], csrf: [] }] } },
    "/admin/kyc/{id}/documents/{documentId}/decision": { post: { tags: ["Admin"], summary: "Accept or deny one KYC document", security: [{ cookieSession: [], csrf: [] }] } },
    "/admin/kyc/{id}/decision": { post: { tags: ["Admin"], summary: "Record the final KYC decision or audited override", security: [{ cookieSession: [], csrf: [] }] } },
    ...
    "/admin/notifications": { get: { tags: ["Admin"], summary: "List notification activity", security: [{ cookieSession: [] }] }, post: { tags: ["Admin"], summary: "Send a manual notification", security: [{ cookieSession: [], csrf: [] }] } },
    "/admin/notifications/inbox": { get: { tags: ["Admin"], summary: "Poll the shared admin notification inbox", security: [{ cookieSession: [] }] } },
    "/admin/notifications/{id}/read": { post: { tags: ["Admin"], summary: "Mark an admin inbox notification as read", security: [{ cookieSession: [], csrf: [] }] } },
    "/admin/notifications/read-all": { post: { tags: ["Admin"], summary: "Mark all admin inbox notifications as read", security: [{ cookieSession: [], csrf: [] }] } },
