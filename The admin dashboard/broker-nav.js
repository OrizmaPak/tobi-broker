(function () {
  ...
  function authLayout(kind) {
    ...
    return '' +
      ...
      '<div class="bp-auth-topline"><span class="bp-auth-mark">$</span><span>BullPort</span><strong>Client Portal</strong></div>' +
      '<div class="bp-auth-copy"><p class="bp-auth-kicker">Broker investment workspace</p><h1>' + config.title + '</h1><p>' + config.subtitle + '</p></div>' +
      '<div class="bp-auth-market-card"><div><span>Portfolio value</span><strong>$164,380</strong></div><div><span>Wallet available</span><strong>$24,850</strong></div><div><span>Risk profile</span><strong>Balanced</strong></div></div>' +
      '<div class="bp-auth-terminal"><div class="bp-auth-terminal-head"><span></span><span></span><span></span><strong>Account workflow</strong></div><div class="bp-auth-steps"><div><b>01</b><span>KYC review</span><strong>Under final review</strong></div><div><b>02</b><span>Funding</span><strong>Bank and crypto rails</strong></div><div><b>03</b><span>Portfolio access</span><strong>6 managed models</strong></div><div><b>04</b><span>Reporting</span><strong>Statements and exports</strong></div></div></div>' +
      ...
      '<form class="bp-auth-form">' + authFields + '<button class="bp-auth-submit" data-broker-action="' + action + '" type="button">' + config.cta + '<span>-></span></button></form>' +
      trustStrip +
  ...
  function injectStyles() {
    ...
    style.textContent = ""
      ...
      + " .bp-auth-page{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:32px;background:radial-gradient(circle at 20% 10%,rgba(34,197,94,.16),transparent 30%),linear-gradient(135deg,#eef6ef 0%,#f8fafc 45%,#e8f3ea 100%);color:#101713}"
      + " .bp-auth-shell{width:min(1180px,100%);display:grid;grid-template-columns:minmax(0,1.08fr) minmax(380px,.72fr);gap:20px;align-items:stretch}"
      ...
      + " .bp-auth-hero{min-height:640px;border-radius:28px;background:linear-gradient(135deg,#0e1a13 0%,#16251b 52%,#0b120e 100%);color:#fff;padding:32px;display:flex;flex-direction:column;justify-content:space-between}"
      + " .bp-auth-hero:before{content:'';position:absolute;inset:auto -20% -35% 28%;height:340px;background:radial-gradient(circle,rgba(34,197,94,.32),transparent 64%);pointer-events:none}"
      + " .bp-auth-hero:after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px),linear-gradient(0deg,rgba(255,255,255,.035) 1px,transparent 1px);background-size:54px 54px;mask-image:linear-gradient(180deg,rgba(0,0,0,.6),transparent 82%);pointer-events:none}"
      ...
      + " .bp-auth-copy{max-width:640px;margin-top:44px}"
      + " .bp-auth-kicker{display:inline-flex;margin:0 0 16px;padding:8px 12px;border:1px solid rgba(255,255,255,.16);border-radius:999px;background:rgba(255,255,255,.08);color:#9cf4a9;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.08em}"
      + " .bp-auth-copy h1{margin:0;font-size:clamp(2.4rem,4vw,4.8rem);line-height:.96;font-weight:850;letter-spacing:0;color:#fff}"
      + " .bp-auth-copy>p:not(.bp-auth-kicker){margin:20px 0 0;max-width:560px;color:rgba(255,255,255,.74);font-size:17px;line-height:1.7}"
      ...
      + " .bp-auth-card{border-radius:28px;background:rgba(255,255,255,.94);padding:32px;align-self:stretch;display:flex;flex-direction:column;justify-content:center;backdrop-filter:blur(20px)}"
      ...
      + " .bp-auth-submit{height:54px;border:0;border-radius:14px;background:#19b72f;color:#fff;display:flex;align-items:center;justify-content:center;gap:10px;font-size:14px;font-weight:850;cursor:pointer;box-shadow:0 18px 34px rgba(25,183,47,.28);transition:transform .18s ease,box-shadow .18s ease,background .18s ease}.bp-auth-submit:hover{background:#129d27;transform:translateY(-1px);box-shadow:0 22px 38px rgba(25,183,47,.32)}.bp-auth-submit span{font-size:18px;line-height:1}"
      ...
      + " @media (max-width:1023px){.bp-auth-page{padding:20px}.bp-auth-shell{grid-template-columns:1fr}.bp-auth-hero{min-height:auto}.bp-auth-card{min-height:auto}.bp-auth-copy{margin-top:34px}}"
      + " @media (max-width:640px){.bp-auth-page{padding:12px;align-items:flex-start}.bp-auth-hero,.bp-auth-card{border-radius:22px;padding:22px}.bp-auth-copy h1{font-size:2.35rem}.bp-auth-copy>p:not(.bp-auth-kicker){font-size:15px}.bp-auth-market-card,.bp-auth-steps,.bp-auth-grid{grid-template-columns:1fr}.bp-auth-topline strong{display:none}.bp-auth-card-head h2{font-size:25px}.bp-auth-foot .flex{display:grid!important}.bp-auth-market-card strong{font-size:21px}}"
