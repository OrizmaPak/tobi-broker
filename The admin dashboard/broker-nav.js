(function () {
  ...
  function authLayout(kind) {
    ...
    const accountVisual = kind === "forgot"
      ...
      : '<div class="bp-auth-account-card"><div><span>Active account</span><strong>BP-447215</strong></div><p>Tobi Adeyemi</p><div class="bp-auth-mini-chart"><i style="height:34%"></i><i style="height:48%"></i><i style="height:42%"></i><i style="height:62%"></i><i style="height:74%"></i><i style="height:88%"></i></div><div class="bp-auth-account-row"><span>Projected allocation</span><strong>Balanced Growth</strong></div></div>';
    ...
    return '' +
      ...
      '<div class="bp-auth-visual-row"><div class="bp-auth-terminal"><div class="bp-auth-terminal-head"><span></span><span></span><span></span><strong>Account workflow</strong></div><div class="bp-auth-steps"><div><b>01</b><span>KYC review</span><strong>Under final review</strong></div><div><b>02</b><span>Funding</span><strong>Bank and crypto rails</strong></div><div><b>03</b><span>Portfolio access</span><strong>6 managed models</strong></div><div><b>04</b><span>Reporting</span><strong>Statements and exports</strong></div></div></div>' + accountVisual + '</div>' +
