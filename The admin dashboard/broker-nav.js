(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = ""
      ...
      + ":root,.dark{--sidebar:oklch(100% 0 0);--sidebar-foreground:oklch(18% .018 230);--sidebar-accent:oklch(96.5% .018 142);--sidebar-accent-foreground:oklch(20% .02 142);--sidebar-border:oklch(91% .006 230);--sidebar-primary:oklch(55% .195 142);--sidebar-primary-foreground:oklch(100% 0 0)}"
      ...
      + " aside.bg-sidebar{background:#fff!important;color:#101713;border-right:1px solid #e2e8f0}"
      + " aside .border-sidebar-border{border-color:#e2e8f0!important}"
