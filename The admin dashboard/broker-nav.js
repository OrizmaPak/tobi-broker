(function () {
  ...
  function shell(title, subtitle, body) {
    const state = getState();
    const isDashboard = currentFile() === "dashboard.html" || currentFile() === "index.html";
    const heroSection = isDashboard
      ? '<section class="broker-dashboard-hero relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-sm sm:p-6 xl:p-7"><div class="broker-dashboard-hero-glow"></div><div class="relative grid gap-6 xl:grid-cols-[minmax(0,1.05fr)_minmax(360px,.95fr)] xl:items-stretch"><div class="flex min-w-0 flex-col justify-between gap-6"><div><div class="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary"><span class="h-1.5 w-1.5 rounded-full bg-primary"></span>BullPort command center</div><h1 class="mt-4 max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl">Your investment control room</h1><p class="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">Monitor wallet funds, managed portfolios, payouts and compliance readiness from one focused client workspace.</p></div><div class="flex flex-wrap gap-3"><button type="button" data-broker-action="goto-deposit" class="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm shadow-primary/20">Fund wallet</button><button type="button" data-broker-action="goto-kyc" class="inline-flex items-center rounded-md border border-border bg-background/80 px-4 py-2 text-sm font-medium text-foreground">Review KYC</button><button type="button" data-broker-action="goto-reports" class="inline-flex items-center rounded-md border border-border bg-background/80 px-4 py-2 text-sm font-medium text-foreground">Statements</button></div></div><div class="grid gap-3 sm:grid-cols-2"><div class="broker-dashboard-value-card sm:col-span-2"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Total portfolio value</p><div class="mt-3 flex flex-wrap items-end justify-between gap-3"><p class="text-3xl font-semibold tracking-tight sm:text-4xl">' + money(DEMO.client.totalPortfolioValue) + '</p><span class="rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-300">P/L ' + money(DEMO.client.profitLoss) + '</span></div><div class="mt-4 grid gap-2 sm:grid-cols-3"><div><p class="text-xs text-muted-foreground">Wallet</p><p class="mt-1 font-semibold">' + money(state.walletBalance) + '</p></div><div><p class="text-xs text-muted-foreground">Active mandates</p><p class="mt-1 font-semibold">' + state.activeInvestments + '</p></div><div><p class="text-xs text-muted-foreground">Pending withdrawal</p><p class="mt-1 font-semibold">' + money(state.pendingWithdrawal) + '</p></div></div></div><div class="rounded-xl border border-border/70 bg-background/70 p-4"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">KYC status</p><div class="mt-3 flex items-center justify-between gap-3"><p class="text-sm font-semibold">' + state.kycStatus + '</p>' + badge(state.kycStatus, statusTone(state.kycStatus)) + '</div></div><div class="rounded-xl border border-border/70 bg-background/70 p-4"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Risk profile</p><p class="mt-3 text-sm font-semibold">' + DEMO.client.riskProfile + '</p><p class="mt-1 text-xs text-muted-foreground">Next payout: <span data-broker-next-payout>' + state.nextPayout + '</span></p></div></div></div></section>'
      : '<section class="broker-page-hero relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-sm sm:p-6"><div class="broker-dashboard-hero-glow"></div><div class="relative flex flex-col gap-5 xl:flex-row xl:items-stretch xl:justify-between"><div class="min-w-0 xl:max-w-3xl"><div class="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary"><span class="h-1.5 w-1.5 rounded-full bg-primary"></span>BullPort client portal</div><h1 class="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">' + title + '</h1><p class="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground sm:text-base">' + subtitle + '</p><div class="mt-5 flex flex-wrap gap-3"><button type="button" data-broker-action="goto-deposit" class="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm shadow-primary/20">Fund wallet</button><button type="button" data-broker-action="goto-kyc" class="inline-flex items-center rounded-md border border-border bg-background/80 px-4 py-2 text-sm font-medium text-foreground">Review KYC</button><button type="button" data-broker-action="goto-reports" class="inline-flex items-center rounded-md border border-border bg-background/80 px-4 py-2 text-sm font-medium text-foreground">Statements</button></div></div><div class="grid gap-3 sm:grid-cols-2 xl:w-[520px]"><div class="rounded-xl border border-border/70 bg-background/70 p-4"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Client</p><p class="mt-2 text-sm font-semibold">' + DEMO.client.name + '</p></div><div class="rounded-xl border border-border/70 bg-background/70 p-4"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Available wallet</p><p class="mt-2 text-sm font-semibold">' + money(state.walletBalance) + '</p></div><div class="rounded-xl border border-border/70 bg-background/70 p-4"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">KYC status</p><div class="mt-2 flex items-center justify-between gap-3"><span class="text-sm font-semibold">' + state.kycStatus + '</span>' + badge(state.kycStatus, statusTone(state.kycStatus)) + '</div></div><div class="rounded-xl border border-border/70 bg-background/70 p-4"><p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Next payout</p><p class="mt-2 text-sm font-semibold" data-broker-next-payout>' + state.nextPayout + '</p></div></div></div></section>';
  ...
  function renderPortalState(message, failed) {
    ...
    main.innerHTML = '' +
      ...
      '<section class="broker-page-hero relative overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-sm">' +
      ...
      '<span class="flex h-16 w-16 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 text-2xl font-bold text-primary shadow-sm' + (failed ? '' : ' animate-pulse') + '">$</span>' +
  ...
  function injectStyles() {
    ...
    style.textContent = ""
      ...
      + " .broker-page-hero{background:linear-gradient(135deg,rgba(255,255,255,.97),rgba(246,251,248,.95) 48%,rgba(255,255,255,.98));isolation:isolate}"
      + " .dark .broker-dashboard-hero{background:linear-gradient(135deg,rgba(16,24,20,.96),rgba(17,32,24,.92) 48%,rgba(10,15,12,.98))}"
      + " .dark .broker-page-hero{background:linear-gradient(135deg,rgba(16,24,20,.96),rgba(20,33,25,.92) 48%,rgba(10,15,12,.98))}"
      ...
      + " @media (max-width:640px){.broker-dashboard-hero,.broker-page-hero{padding:18px}.broker-dashboard-hero h1,.broker-page-hero h1{font-size:1.875rem;line-height:2.2rem}.broker-dashboard-value-card{padding:16px}}"
